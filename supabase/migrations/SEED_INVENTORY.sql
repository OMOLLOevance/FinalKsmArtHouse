-- EXECUTE THIS AFTER CREATING TABLES IN SUPABASE SQL EDITOR
-- This seeds the predefined inventory items
...
-- Verify insertion
SELECT category, COUNT(*) as item_count, SUM(in_store) as total_inventory
