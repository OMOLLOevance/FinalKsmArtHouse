...
DROP POLICY IF EXISTS "gym_finances_insert" ON public.gym_finances;
DROP POLICY IF EXISTS "gym_finances_select" ON public.gym_finances;
DROP POLICY IF EXISTS "gym_finances_update" ON public.gym_finances;
DROP POLICY IF EXISTS "gym_finances_delete" ON public.gym_finances;
DROP POLICY IF EXISTS "restaurant_sales_insert" ON public.restaurant_sales;
DROP POLICY IF EXISTS "restaurant_sales_select" ON public.restaurant_sales;
DROP POLICY IF EXISTS "restaurant_sales_update" ON public.restaurant_sales;
DROP POLICY IF EXISTS "restaurant_sales_delete" ON public.restaurant_sales;
DROP POLICY IF EXISTS "sauna_bookings_insert" ON public.sauna_bookings;
DROP POLICY IF EXISTS "sauna_bookings_select" ON public.sauna_bookings;
DROP POLICY IF EXISTS "sauna_bookings_update" ON public.sauna_bookings;
DROP POLICY IF EXISTS "sauna_bookings_delete" ON public.sauna_bookings;
DROP POLICY IF EXISTS "sauna_spa_finances_insert" ON public.sauna_spa_finances;
DROP POLICY IF EXISTS "sauna_spa_finances_select" ON public.sauna_spa_finances;
DROP POLICY IF EXISTS "sauna_spa_finances_update" ON public.sauna_spa_finances;
DROP POLICY IF EXISTS "sauna_spa_finances_delete" ON public.sauna_spa_finances;
...
-- 4. Create RBAC policies for gym_finances
...
-- 5. Create RBAC policies for restaurant_sales
...
-- 6. Create RBAC policies for sauna_bookings
...
-- 7. Handle sauna_spa_finances if it exists
...
-- 8. Keep existing policies for non-transaction tables
