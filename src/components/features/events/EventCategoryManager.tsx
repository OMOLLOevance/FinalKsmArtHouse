    ...
    <div className="space-y-6 pb-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-primary uppercase">{title}</h1>
            <p className="text-muted-foreground italic text-xs uppercase font-black tracking-widest opacity-70">Category Management</p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-3">
          ...
          <Button type="button" onClick={() => { setIsNewItem(false); setShowAddDialog(true); }} className="h-10 px-6 font-black uppercase text-[10px] tracking-widest shadow-lg shadow-primary/20 rounded-xl">
