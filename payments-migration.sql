-- =====================================================
-- KSM.ART HOUSE - Payments Table Migration
-- Add support for Gym and Sauna payment tracking
-- =====================================================

-- Step 1: Add new columns
ALTER TABLE public.payments 
ADD COLUMN IF NOT EXISTS service_type TEXT NOT NULL DEFAULT 'quotation',
ADD COLUMN IF NOT EXISTS gym_member_id UUID,
ADD COLUMN IF NOT EXISTS sauna_booking_id UUID;
...
CREATE INDEX IF NOT EXISTS idx_payments_gym_member ON public.payments(gym_member_id);
CREATE INDEX IF NOT EXISTS idx_payments_sauna_booking ON public.payments(sauna_booking_id);
